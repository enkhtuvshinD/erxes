...
import ClientPortalNotificationDetail from '../components/ClientPortalNotificationDetail';
import mutations from '../graphql/mutations';
import queries from '../graphql/queries';
import {
  ClientPortalConfig,
  ClientPortalConfigQueryResponse,
...
function ClientPortalNotificationDetailContainer({
  queryParams,
  history,
  closeModal
}: Props) {
  ...
  const [mutate] = useMutation(gql(mutations.clientPortalNotificationsCreate), {
  ...
  const handleUpdate = (doc: ClientPortalNotification) => {
  ...
  return <ClientPortalNotificationDetail {...updatedProps} />;
}

export default ClientPortalNotificationDetailContainer;
